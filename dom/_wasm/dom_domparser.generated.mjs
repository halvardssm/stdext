...
const JsDOMParserFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
export class JsDOMParser {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        JsDOMParserFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_jsdomparser_free(ptr);
    }
    /**
    ...
    */
    constructor() {
        const ret = wasm.jsdomparser_new();
...
const wasm_url = new URL('dom_domparser.generated.wasm', import.meta.url);
let wasmCode = '';
